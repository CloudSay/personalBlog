<template><h1 id="性能" tabindex="-1"><a class="header-anchor" href="#性能" aria-hidden="true">#</a> 性能</h1>
<h2 id="网络相关" tabindex="-1"><a class="header-anchor" href="#网络相关" aria-hidden="true">#</a> 网络相关</h2>
<h3 id="dns-预解析" tabindex="-1"><a class="header-anchor" href="#dns-预解析" aria-hidden="true">#</a> DNS 预解析</h3>
<p>DNS 解析也是需要时间的，可以通过预解析的方式来预先获得域名所对应的 IP。</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>dns-prefetch<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>//yuchengkai.cn<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h3 id="缓存" tabindex="-1"><a class="header-anchor" href="#缓存" aria-hidden="true">#</a> 缓存</h3>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token literal-property property">Expires</span><span class="token operator">:</span> Wed<span class="token punctuation">,</span> <span class="token number">22</span> Oct <span class="token number">2018</span> <span class="token number">08</span><span class="token operator">:</span><span class="token number">41</span><span class="token operator">:</span><span class="token number">00</span> <span class="token constant">GMT</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p><code>Expires</code> 是 HTTP / 1.0 的产物，表示资源会在 <code>Wed, 22 Oct 2018 08:41:00 GMT</code> 后过期，需要再次请求。并且 <code>Expires</code> 受限于本地时间，如果修改了本地时间，可能会造成缓存失效。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>Cache<span class="token operator">-</span>control<span class="token operator">:</span> max<span class="token operator">-</span>age<span class="token operator">=</span><span class="token number">30</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p><code>Cache-Control</code> 出现于 HTTP / 1.1，优先级高于 <code>Expires</code> 。该属性表示资源会在 30 秒后过期，需要再次请求。</p>
...
<h5 id="last-modified-和-if-modified-since" tabindex="-1"><a class="header-anchor" href="#last-modified-和-if-modified-since" aria-hidden="true">#</a> Last-Modified 和 If-Modified-Since</h5>
...
<h5 id="etag-和-if-none-match" tabindex="-1"><a class="header-anchor" href="#etag-和-if-none-match" aria-hidden="true">#</a> ETag 和 If-None-Match</h5>
...
<h4 id="选择合适的缓存策略" tabindex="-1"><a class="header-anchor" href="#选择合适的缓存策略" aria-hidden="true">#</a> 选择合适的缓存策略</h4>
...
<h3 id="使用-http-2-0" tabindex="-1"><a class="header-anchor" href="#使用-http-2-0" aria-hidden="true">#</a> 使用 HTTP / 2.0</h3>
...
<p>更详细的内容你可以查看 <RouterLink to="/Network/Network-zh.html##http-20">该小节</RouterLink></p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>预加载可以一定程度上降低首屏的加载时间，因为可以将一些不影响首屏但重要的文件延后加载，唯一缺点就是兼容性不好。</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>预渲染虽然可以提高页面的加载速度，但是要确保该页面百分百会被用户在之后打开，否则就白白浪费资源去渲染</p>
<h2 id="优化渲染过程" tabindex="-1"><a class="header-anchor" href="#优化渲染过程" aria-hidden="true">#</a> 优化渲染过程</h2>
<p>对于代码层面的优化，你可以查阅浏览器系列中的 <RouterLink to="/Browser/browser-ch.html#%E6%B8%B2%E6%9F%93%E6%9C%BA%E5%88%B6">相关内容</RouterLink>。</p>
<h3 id="懒执行" tabindex="-1"><a class="header-anchor" href="#懒执行" aria-hidden="true">#</a> 懒执行</h3>
...
<h2 id="文件优化" tabindex="-1"><a class="header-anchor" href="#文件优化" aria-hidden="true">#</a> 文件优化</h2>
<h3 id="图片优化" tabindex="-1"><a class="header-anchor" href="#图片优化" aria-hidden="true">#</a> 图片优化</h3>
<h4 id="计算图片大小" tabindex="-1"><a class="header-anchor" href="#计算图片大小" aria-hidden="true">#</a> 计算图片大小</h4>
...
<h4 id="图片加载优化" tabindex="-1"><a class="header-anchor" href="#图片加载优化" aria-hidden="true">#</a> 图片加载优化</h4>
<ol>
...
<h3 id="其他文件优化" tabindex="-1"><a class="header-anchor" href="#其他文件优化" aria-hidden="true">#</a> 其他文件优化</h3>
<ul>
...
<h3 id="使用-webpack-优化项目" tabindex="-1"><a class="header-anchor" href="#使用-webpack-优化项目" aria-hidden="true">#</a> 使用 Webpack 优化项目</h3>
<ul>
...
<p><strong>如何渲染几万条数据并不卡住界面</strong></p>
