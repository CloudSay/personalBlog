...
<h3 id="面向报文" tabindex="-1"><a class="header-anchor" href="#面向报文" aria-hidden="true">#</a> 面向报文</h3>
...
<h3 id="不可靠性" tabindex="-1"><a class="header-anchor" href="#不可靠性" aria-hidden="true">#</a> 不可靠性</h3>
<ol>
...
<h3 id="高效" tabindex="-1"><a class="header-anchor" href="#高效" aria-hidden="true">#</a> 高效</h3>
...
<h3 id="传输方式" tabindex="-1"><a class="header-anchor" href="#传输方式" aria-hidden="true">#</a> 传输方式</h3>
...
<h4 id="建立连接三次握手" tabindex="-1"><a class="header-anchor" href="#建立连接三次握手" aria-hidden="true">#</a> 建立连接三次握手</h4>
...
<h4 id="断开链接四次握手" tabindex="-1"><a class="header-anchor" href="#断开链接四次握手" aria-hidden="true">#</a> 断开链接四次握手</h4>
...
<h3 id="arq-协议" tabindex="-1"><a class="header-anchor" href="#arq-协议" aria-hidden="true">#</a> ARQ 协议</h3>
<p>ARQ 协议也就是超时重传机制。通过确认和超时机制保证了数据的正确送达，ARQ 协议包含停止等待 ARQ 和连续 ARQ</p>
<h4 id="停止等待-arq" tabindex="-1"><a class="header-anchor" href="#停止等待-arq" aria-hidden="true">#</a> 停止等待 ARQ</h4>
...
<h4 id="连续-arq" tabindex="-1"><a class="header-anchor" href="#连续-arq" aria-hidden="true">#</a> 连续 ARQ</h4>
<p>在连续 ARQ 中，发送端拥有一个发送窗口，可以在没有收到应答的情况下持续发送窗口内的数据，这样相比停止等待 ARQ 协议来说减少了等待时间，提高了效率。</p>
<h4 id="累计确认" tabindex="-1"><a class="header-anchor" href="#累计确认" aria-hidden="true">#</a> 累计确认</h4>
...
<h3 id="滑动窗口" tabindex="-1"><a class="header-anchor" href="#滑动窗口" aria-hidden="true">#</a> 滑动窗口</h3>
...
<h4 id="zero-窗口" tabindex="-1"><a class="header-anchor" href="#zero-窗口" aria-hidden="true">#</a> Zero 窗口</h4>
<p>在发送报文的过程中，可能会遇到对端出现零窗口的情况。在该情况下，发送端会停止发送数据，并启动 persistent timer 。该定时器会定时发送请求给对端，让对端告知窗口大小。在重试次数超过一定次数后，可能会中断 TCP 链接。</p>
<h3 id="拥塞处理" tabindex="-1"><a class="header-anchor" href="#拥塞处理" aria-hidden="true">#</a> 拥塞处理</h3>
<p>拥塞处理和流量控制不同，后者是作用于接收方，保证接收方来得及接受数据。而前者是作用于网络，防止过多的数据拥塞网络，避免出现网络负载过大的情况。</p>
<p>拥塞处理包括了四个算法，分别为：慢开始，拥塞避免，快速重传，快速恢复。</p>
<h4 id="慢开始算法" tabindex="-1"><a class="header-anchor" href="#慢开始算法" aria-hidden="true">#</a> 慢开始算法</h4>
...
<h4 id="拥塞避免算法" tabindex="-1"><a class="header-anchor" href="#拥塞避免算法" aria-hidden="true">#</a> 拥塞避免算法</h4>
...
<h4 id="tcp-new-ren-改进后的快恢复" tabindex="-1"><a class="header-anchor" href="#tcp-new-ren-改进后的快恢复" aria-hidden="true">#</a> TCP New Ren 改进后的快恢复</h4>
...
<h3 id="post-和-get-的区别" tabindex="-1"><a class="header-anchor" href="#post-和-get-的区别" aria-hidden="true">#</a> Post 和 Get 的区别</h3>
<p>先引入副作用和幂等的概念。</p>
...
<h3 id="常见状态码" tabindex="-1"><a class="header-anchor" href="#常见状态码" aria-hidden="true">#</a> 常见状态码</h3>
...
<h3 id="http-首部" tabindex="-1"><a class="header-anchor" href="#http-首部" aria-hidden="true">#</a> HTTP 首部</h3>
<table>
<thead>
<tr>
...
<p>PS：缓存相关已在别的模块中写完，你可以 <RouterLink to="/Performance/performance-ch.html#%E7%BC%93%E5%AD%98">阅读该小节</RouterLink></p>
...
<h3 id="tls" tabindex="-1"><a class="header-anchor" href="#tls" aria-hidden="true">#</a> TLS</h3>
...
<h3 id="二进制传输" tabindex="-1"><a class="header-anchor" href="#二进制传输" aria-hidden="true">#</a> 二进制传输</h3>
...
<h3 id="header-压缩" tabindex="-1"><a class="header-anchor" href="#header-压缩" aria-hidden="true">#</a> Header 压缩</h3>
...
<h3 id="服务端-push" tabindex="-1"><a class="header-anchor" href="#服务端-push" aria-hidden="true">#</a> 服务端 Push</h3>
...
<h3 id="quic" tabindex="-1"><a class="header-anchor" href="#quic" aria-hidden="true">#</a> QUIC</h3>
...
<h2 id="从输入-url-到页面加载完成的过程" tabindex="-1"><a class="header-anchor" href="#从输入-url-到页面加载完成的过程" aria-hidden="true">#</a> 从输入 URL 到页面加载完成的过程</h2>
